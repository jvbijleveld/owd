...
public class SimpleLocation {
     ...
     *            whether to use passive mode (to save battery) or active mode
     * @param interval
     *            the interval to request new location updates after (in milliseconds) where longer intervals save
     *            battery
     */
     ...
     *
     * @param listener
     *            the `SimpleLocation.Listener` instance to attach or `null` to detach
     */
    ...
    /**
     * Blurs the specified location with the defined blur radius or returns an unchanged location if no blur radius is
     * set
     *
    ...
    /**
     * Returns the name of the location provider that matches the specified settings and depends on the given
     * granularity
     *
     * @param whether
